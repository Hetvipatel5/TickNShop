...
(1, 'admin', '0192023a7bbd73250516f069df18b500', '2025-09-15 15:55:24');
...
INSERT INTO `cart` (`id`, `user_id`, `session_id`, `product_id`, `quantity`, `added_on`) VALUES
(5, NULL, 'l0b5fq4ip1drn36pai5qnp7a28', 24, 1, '2025-09-10 16:31:51'),
(6, NULL, 'qvc3nuqr4cl265erl1vepngf4v', 30, 2, '2025-09-11 04:30:08'),
(7, NULL, 'qvc3nuqr4cl265erl1vepngf4v', 40, 1, '2025-09-11 04:34:28'),
(16, NULL, '966a51ivobuunngpjkls2v7fu2', 37, 1, '2025-09-21 17:00:17');
...
(1, 'misa patel', 'misa123@gmail.com', 'inquiry', 'i want to know about the product', '2025-09-12 22:02:27');
...
(1, 'hetvi satishkumar patel', 'hetvipatel2069@gmail.com', 5, 'it was a great experience', '2025-09-12 15:17:35');
...
INSERT INTO `orders` (`order_id`, `user_id`, `fullname`, `email`, `phone`, `payment_method`, `address`, `created_at`, `status`, `total_amount`) VALUES
(1, 1, 'hetvi satishkumar patel', 'hetvipatel2069@gmail.com', '8733949999', 'COD', 'vir vital bhumi\r\ndasaj raod', '2025-09-13 19:58:27', 'delivered', 114799.00),
(2, 1, 'hetvi satishkumar patel', 'hetvipatel2069@gmail.com', '8733949999', 'COD', 'vir vital bhumi\r\ndasaj raod', '2025-09-13 19:59:48', 'pending', 112000.00),
(3, 1, '', '', '', 'UPI', '', '2025-09-13 20:40:42', 'pending', 9999.00);
...
INSERT INTO `returns` (`id`, `order_id`, `reason`, `comments`, `created_at`) VALUES
(1, '1', 'defective', 'i have recieved a defective product', '2025-09-12 21:50:08');
